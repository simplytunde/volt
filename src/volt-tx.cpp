...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Volt Core volt-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  volt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded volt transaction") + "\n" +
                               "  volt-tx [options] -create [commands]   " + _("Create hex-encoded volt transaction") + "\n" +
                               "\n";
