...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Volt: 1 day
        nTargetSpacing = 1 * 60;  // Volt: 1 minute
        nMaturity = 50;
        ...
        vSeeds.push_back(CDNSSeedData("0", "dns0.volt.io"));
        vSeeds.push_back(CDNSSeedData("1", "dns1.volt.io"));
        vSeeds.push_back(CDNSSeedData("2", "dns2.volt.io"));
        vSeeds.push_back(CDNSSeedData("3", "dns3.volt.io"));
        vSeeds.push_back(CDNSSeedData("4", "dns4.volt.io"));
        vSeeds.push_back(CDNSSeedData("5", "dns5.volt.io"));
        vSeeds.push_back(CDNSSeedData("6", "dns6.volt.io"));
        vSeeds.push_back(CDNSSeedData("7", "dns7.volt.io"));
        vSeeds.push_back(CDNSSeedData("8", "dns8.volt.io"));
        vSeeds.push_back(CDNSSeedData("9", "dns9.volt.io"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Volt: 1 day
        nTargetSpacing = 1 * 10;  // Volt: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Volt: 1 day
        nTargetSpacing = 1 * 60;        // Volt: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1505224800;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 12345;
