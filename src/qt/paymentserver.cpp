...
const char* BIP71_MIMETYPE_PAYMENT = "application/volt-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/volt-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/volt-paymentrequest";
...
//
// OSX-specific way of handling volt: URIs and
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in volt: URIs
...
bool PaymentServer::processPaymentRequest(PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    foreach (const PAIRTYPE(CScript, CAmount) & sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Insecure payments to custom volt addresses are not supported
