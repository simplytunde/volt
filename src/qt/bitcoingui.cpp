                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Volt Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Volt address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and volt: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Volt Core"), this);
    aboutAction->setStatusTip(tr("Show information about Volt Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Volt"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Volt addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Volt addresses"));
    ...
    openAction->setStatusTip(tr("Open a Volt: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Volt Core help message to get a list with possible Volt command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Volt Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Volt network", "", count));
}
...
{
    QString strTitle = tr("Volt Core"); // default title
