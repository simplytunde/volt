...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Volt features */
        {"volt", "masternode", &masternode, true, true, false},
        {"volt", "listmasternodes", &listmasternodes, true, true, false},
        {"volt", "getmasternodecount", &getmasternodecount, true, true, false},
        {"volt", "masternodeconnect", &masternodeconnect, true, true, false},
        {"volt", "masternodecurrent", &masternodecurrent, true, true, false},
        {"volt", "masternodedebug", &masternodedebug, true, true, false},
        {"volt", "startmasternode", &startmasternode, true, true, false},
        {"volt", "createmasternodekey", &createmasternodekey, true, true, false},
        {"volt", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"volt", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"volt", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"volt", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"volt", "getmasternodescores", &getmasternodescores, true, true, false},
        {"volt", "mnbudget", &mnbudget, true, true, false},
        {"volt", "preparebudget", &preparebudget, true, true, false},
        {"volt", "submitbudget", &submitbudget, true, true, false},
        {"volt", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"volt", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"volt", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"volt", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"volt", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"volt", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"volt", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"volt", "checkbudgets", &checkbudgets, true, true, false},
        {"volt", "mnsync", &mnsync, true, true, false},
        {"volt", "spork", &spork, true, true, false},
        {"volt", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"volt", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use voltd, or the -server option to volt-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
