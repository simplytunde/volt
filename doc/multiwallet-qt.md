...
In order to support loading of multiple wallets in volt-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is volt.cpp.
...
Changes to volt.cpp
----------------------
volt.cpp is the entry point into volt-qt, and as such, will require some minor modifications to provide hooks for
