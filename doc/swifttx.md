...
* WebSocket: [https://github.com/voltproject/insight-api-volt#web-socket-api](https://github.com/voltproject/insight-api-volt#web-socket-api) 
* API: [https://github.com/voltproject/insight-api-volt#swifttx-transactions](https://github.com/voltproject/insight-api-volt#swifttx-transactions) 
...
By default, the Volt Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Volt Core daemon:
