...
```
./voltd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```
...
HiddenServicePort 989 127.0.0.1:10581
...
```
./voltd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
and open port 10581 on your firewall (or use -upnp).
